...
/**
 * Hybrid credentials encryptor that combines asymmetric with a symmetric encryptor, that follows
 ...
 *
 * Output format</br>
 * {@code $identifier$version$base64(encrypted-secret-key)$base64(symmetrically-encrypted-credentials)}</br>
