package io.github.ysdaeth.jccredentials.rsa.impl;

import io.github.ysdaeth.jccredentials.core.rsa.BaseRsa;
import io.github.ysdaeth.jccredentials.core.rsa.BaseRsaFactory;
import io.github.ysdaeth.jccredentials.jcc.api.AsymmetricEncryptor;
...
import io.github.ysdaeth.jccredentials.rsa.impl.config.ModelSerializerConfig;
 ...
 * It uses {@link ModelSerializerConfig} for
 * {@link Serializer}.
...
public final class EncryptorRsaOaep implements AsymmetricEncryptor {
    ...
    /**
     * Encrypt character sequence with public key and return Modular Crypt Format string value.
    ...
    public String encrypt(byte[] secret) throws KeyException{
        ...
        try{
            ...
            McfModel mcf = new McfModel(ID,VERSION,encrypted);
     ...
     * @return decrypted MCF as string
     * @throws KeyException when key does not match or is invalid
     */
    @Override
    public byte[] decrypt(String serializedMcf) throws KeyException{
        McfModel mcf = serializer.deserialize(serializedMcf,McfModel.class);
    ...
    private static final class McfModel{
        ...
        @SerializerCreator
        public McfModel(String identifier, String version, byte[] encrypted) {
